...
const routes: Routes = [
  ...
  {path:'home',component:DefaultComponent,children:[{path:'home',component:RepositorioComponent},{path:'metadato',component: MetadatoComponent},{path:'cambios',component: CambiosComponent},
